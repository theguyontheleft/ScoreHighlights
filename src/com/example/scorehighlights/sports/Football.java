 ...
 * @version Oct 1, 2013
 * 
 *          This is the football derivation of the SportsAbstract class
 * 
 */
public class Football extends SportsAbstract<String, JSONObject>
{
     ...
     * @param object
     */
    public Football( String headlineString, JSONObject object )
    {
