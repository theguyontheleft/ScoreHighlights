 ...
 * @version Oct 1, 2013
 * 
 *          This is the hockey derivation of the SportsAbstract class
 * 
 */
public class Hockey extends SportsAbstract<String, JSONObject>
{
     ...
     * @param object
     */
    public Hockey( String headlineString, JSONObject object )
    {
