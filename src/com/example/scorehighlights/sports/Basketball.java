 ...
 * @version Oct 1, 2013
 * 
 *          This is the basketball derivation of the SportsAbstract class
 * 
 */
public class Basketball extends SportsAbstract<String, JSONObject>
{
    /**
     * @param headlineString
     * @param object 
     */
    public Basketball( String headlineString, JSONObject object )
    {
