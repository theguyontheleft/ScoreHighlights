 ...
 * @version Oct 1, 2013
 * 
 *          This is the baseball derivation of the SportsAbstract class
 * 
 */
public class Baseball extends SportsAbstract<String, JSONObject>
{
    /**
     * @param headlineString
     * @param object
     */
    public Baseball( String headlineString, JSONObject object )
    {
