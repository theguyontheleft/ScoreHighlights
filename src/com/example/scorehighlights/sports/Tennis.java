 ...
 * @version Oct 1, 2013
 * 
 *          This is the tennis derivation of the SportsAbstract class
 * 
 */
public class Tennis extends SportsAbstract<String, JSONObject>
{
     ...
     * @param object
     */
    public Tennis( String headlineString, JSONObject object )
    {
